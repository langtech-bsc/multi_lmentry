...
class LeastAssociatedWord(LMentryTask):
    ...
    def __init__(self, name="least_associated_word"):
        ...
        self.canonical_template = '{options} hitzen artean, zeinek du lotura gutxien "{category}" kategoriarekin?'
        self.second_template = 'Zein hitz erlazionatzen da gutxien "{category}" kategoriarekin {options} hitzen artean?'
        self.third_template = 'Hurrengo hitzen artean, aukeratu "{category}" kategoriarekin lotura gutxien duen hitza - {options}:'
