...
class StartsWithWord(LMentryTask):
    ...
    def __init__(self, name="starts_with_word"):
        super().__init__(name)
        self.canonical_template = 'Idatzi "{word}" hitzarekin hasten den esaldi bat:'
        self.second_template = 'Idatzi esaldi bat zeinen lehenengo hitza "{word}" den:'
        self.third_template = 'Idatzi esaldi bat "{word}" hitzarekin hasita:'
