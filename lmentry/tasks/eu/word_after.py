...
class WordAfter(LMentryTask):
    ...
    def __init__(self, name="word_after"):
        ...
        self.canonical_template = '"{sentence}" esaldian, zein hitz dago "{word}" atze-atzetik?'
        self.second_template = '"{sentence}" esaldian, zein hitz dago "{word}" ondoren?'
        self.third_template = 'Zein hitz dator "{word}" eta gero "{sentence}" esaldian?'
