...
class RhymingWordOrthographicallySimilar(LMentryTask):
    ...
    def __init__(self, name="rhyming_word_orthographically_similar"):
        super().__init__(name)
        self.canonical_template = "Hauetako zeinek errimatzen du \"{query}\" hitzarekin: \"{word1}\" edo \"{word2}\"?"
        self.second_template = "Hauetako zeinek du errima \"{query}\" hitzarekin: \"{word1}\" edo \"{word2}\"?"
        self.third_template = "\"{word1}\" eta \"{word2}\" hitzen artean, zeinek errimatzen du \"{query}\" hitzarekin?"
