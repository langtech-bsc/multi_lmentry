...
class FirstLetter(LMentryTask):
    ...
    def __init__(self, name="first_letter"):
        ...
        self.canonical_template = 'Zein da "{word}" hitzaren lehenengo letra?'
        self.second_template = 'Zein letrarekin hasten da "{word}" hitza?'
        self.third_template = 'Idatzi "{word}" hitzaren lehenengo letra:'
