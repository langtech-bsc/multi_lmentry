...
class SentenceContaining(LMentryTask):
    ...
    def __init__(self, name="sentence_containing"):
        super().__init__(name)
        self.canonical_template = 'Idatzi "{word}" hitza duen esaldi bat:'
        self.second_template = 'Idatzi esaldi bat "{word}" hitza erabiliz:'
        self.third_template = 'Idatzi esaldi bat zeinetan "{word}" hitza agertzen den:'
