...
class LastWord(LMentryTask):
    ...
    def __init__(self, name="last_word"):
        ...
        self.canonical_template = 'Zein da "{sentence}" esaldiaren azken hitza?'
        self.second_template = '"{sentence}" esaldian, zein da azken hitza?'
        self.third_template = 'Idatzi "{sentence}" esaldiaren azken hitza:'
