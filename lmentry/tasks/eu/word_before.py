...
class WordBefore(LMentryTask):
    ...
    def __init__(self, name="word_before"):
        ...
        self.canonical_template = '"{sentence}" esaldian, zein hitz dago "{word}" aurre-aurretik?'
        self.second_template = '"{sentence}" esaldian, zein hitz dago "{word}" aurretik?'
        self.third_template = 'Zein hitz dator "{word}" baino lehen "{sentence}" esaldian?'
