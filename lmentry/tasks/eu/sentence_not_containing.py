...
class SentenceNotContaining(LMentryTask):
    ...
    def __init__(self, name="sentence_not_containing"):
        super().__init__(name)
        self.canonical_template = 'Idatzi "{word}" hitza ez duen esaldi bat:'
        self.second_template = 'Idatzi esaldi bat "{word}" hitza erabili gabe:'
        self.third_template = 'Idatzi esaldi bat zeinetan "{word}" hitza ez den agertzen:'
