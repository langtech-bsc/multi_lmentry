...
class MoreLettersLengthDiff1(LMentryTask):
    ...
    def __init__(self, name="more_letters_length_diff_1"):
        ...
        self.canonical_template = 'Zein hitzek du letra gehiago: "{word1}" edo "{word2}"?'
        self.second_template = 'Zein hitz da luzeagoa: "{word1}" edo "{word2}"?'
        self.third_template = '"{word1}" eta "{word2}" hitzen artean, zeinek du letra gehiago?'
