...
class FirstWord(LMentryTask):
    ...
    def __init__(self, name="first_word"):
        ...
        self.canonical_template = 'Zein da "{sentence}" esaldiaren lehenengo hitza?'
        self.second_template = '"{sentence}" esaldian, zein da lehenengo hitza?'
        self.third_template = 'Idatzi "{sentence}" esaldiaren lehenengo hitza:'
