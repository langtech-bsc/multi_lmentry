...
class AllWordsFromCategory1Distractors(LMentryTask):
    ...
    def __init__(self, name="all_words_from_category_1_distractors"):
        ...
        self.canonical_template = '{words} hitzetako guztiak {category} dira? Erantzun "bai" edo "ez".'
        self.second_template = '{words} hitzetako guztiek {category} adierazten dituzte? Erantzun "bai" edo "ez".'
        self.third_template = '[{words}] zerrendak {category} besterik ez ditu? Erantzun "bai" edo "ez".'
    ...
    def _create_input(self, template, words, category):
        ...
        if category in eu_abstract_categories:
            category = f"{comitative_singular(category)} zerikusia duten hitz"
