...
class LastLetter(LMentryTask):
    ...
    def __init__(self, name="last_letter"):
        ...
        self.canonical_template = 'Zein da "{word}" hitzaren azken letra?'
        self.second_template = 'Zein letrarekin amaitzen da "{word}" hitza?'
        self.third_template = 'Idatzi "{word}" hitzaren azken letra:'
