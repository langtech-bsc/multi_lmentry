...
class WordNotContaining(LMentryTask):
    ...
    def __init__(self, name="word_not_containing"):
        super().__init__(name)
        self.canonical_template = 'Idatzi "{letter}" letra ez duen hitz bat:'
        self.second_template = 'Idatzi hitz bat "{letter}" letra ez daukana:'
        self.third_template = 'Idatzi hitz bat zeinetan "{letter}" letra ez den agertzen:'
    ...
    def create_data(self, task_data_path=None):
        ...
        settings["num_examples_per_template"] = len(eu_letters)
