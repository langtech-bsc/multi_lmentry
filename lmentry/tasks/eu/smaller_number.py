...
class SmallerNumber(LMentryTask):
    ...
    def __init__(self, name="smaller_number"):
        super().__init__(name)
        self.canonical_template = "Zein zenbaki da txikiena, {n1} edo {n2}?"
        self.second_template = "{n1} eta {n2} zenbakien artean, zein da txikiena?"
        self.third_template = "{n1} eta {n2} zenbakien artean, aukeratu txikiena:"
