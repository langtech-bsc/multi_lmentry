...
class LessLetters(LMentryTask):
    ...
    def __init__(self, name="less_letters"):
        ...
        self.canonical_template = 'Zein hitzek du letra gutxiago: "{word1}" edo "{word2}"?'
        self.second_template = 'Zein hitz da laburragoa: "{word1}" edo "{word2}"?'
        self.third_template = '"{word1}" eta "{word2}" hitzen artean, zeinek du letra gutxiago?'
