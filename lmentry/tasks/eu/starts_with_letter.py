...
class StartsWithLetter(LMentryTask):
    ...
    def __init__(self, name="starts_with_letter"):
        ...
        self.canonical_template = 'Idatzi "{letter}" letrarekin hasten den hitz bat:'
        self.second_template = 'Idatzi hitz bat zeinen lehenengo letra "{letter}" den:'
        self.third_template = 'Idatzi hitz bat "{letter}" letrarekin hasita:'
    ...
    def create_data(self, task_data_path=None):
        ...
        allowed_letters = set(eu_letters) - {"c", "q", "r", "v", "w", "y"}
