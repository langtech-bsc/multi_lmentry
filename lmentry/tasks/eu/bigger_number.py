...
class BiggerNumber(LMentryTask):
    ...
    def __init__(self, name="bigger_number"):
        super().__init__(name)
        self.canonical_template = "Zein zenbaki da handiena: {n1} edo {n2}?"
        self.second_template = "{n1} eta {n2} zenbakien artean, zein da handiena?"
        self.third_template = "{n1} eta {n2} zenbakien artean, aukeratu handiena:"
