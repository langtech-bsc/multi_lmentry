...
class LessLettersLengthDiff3plus(LMentryTask):
    ...
    def __init__(self, name="less_letters_length_diff_3plus"):
        ...
        self.canonical_template = 'Qual palavra tem menos letras: "{word1}" ou "{word2}"?'
        self.second_template = 'Qual palavra é mais curta: "{word1}" ou "{word2}"?'
        self.third_template = 'Das palavras "{word1}" e "{word2}", qual tem menos letras?'
