...
class StartsWithLetter(LMentryTask):
    ...
    def __init__(self, name="starts_with_letter"):
        ...
        self.canonical_template = 'Escreva uma palavra que comece com a letra "{letter}":'
        self.second_template = 'Escreva uma palavra cuja primeira letra seja "{letter}":'
        self.third_template = 'Escreva uma palavra que comece com "{letter}":'
    ...
    def create_data(self, task_data_path=None):
        ...
        allowed_letters = set(letters) - {"k", "w", "y"}
