...
class LeastAssociatedWord(LMentryTask):
    ...
    def __init__(self, name="least_associated_word"):
        ...
        self.canonical_template = \
            'Dentre as palavras {options}, qual é a palavra menos associada com "{category}"?'
        self.second_template = \
            'Qual palavra é a menos relacionada com "{category}", dentre as palavras {options}?'
        self.third_template = \
            'Dentre as seguintes palavras, escolha a palavra menos associada com "{category}" - {options}:'
