...
class EndsWithLetter(LMentryTask):
    ...
    def __init__(self, name="ends_with_letter"):
        ...
        self.canonical_template = 'Escreva uma palavra que termina com a letra "{letter}":'
        self.second_template = 'Escreva uma palavra cuja última letra seja "{letter}":'
        self.third_template = 'Escreva uma palavra que acabe em "{letter}":'
    ...
    def create_data(self, task_data_path=None):
        ...
        allowed_letters = set(letters) - {"b", "c", "d", "f", "g", "h", "j", "k", "p", "q", "t", "v", "w", "y"}
