...
class MostAssociatedWord(LMentryTask):
    ...
    def __init__(self, name="most_associated_word"):
        ...
        self.canonical_template = \
            'Dentre as palavras {options}, qual é a palavra mais associada com "{category}"?'
        self.second_template = \
            'Que palavra é a mais relacionada com "{category}", dentre as palavras {options}?'
        self.third_template = \
            'Dentre as seguintes palavras, escolha a palavra mais associada com "{category}" - {options}:'
