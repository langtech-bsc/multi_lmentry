...
class EndsWithWord(LMentryTask):
    ...
    def __init__(self, name="ends_with_word"):
        super().__init__(name)
        self.canonical_template = 'Escreva uma frase que termine com a palavra "{word}":'
        self.second_template = 'Escreva uma frase cuja última palavra seja "{word}":'
        self.third_template = 'Escreva uma frase que acabe com "{word}":'
