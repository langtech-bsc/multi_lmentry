...
class LastLetter(LMentryTask):
    ...
    def __init__(self, name="last_letter"):
        ...
        self.canonical_template = 'Qual é a última letra da palavra "{word}"?'
        self.second_template = 'Com que letra termina a palavra "{word}"?'
        self.third_template = 'Escreva a última letra da palavra "{word}":'
