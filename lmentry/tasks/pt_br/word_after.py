...
class WordAfter(LMentryTask):
    ...
    def __init__(self, name="word_after"):
        ...
        self.canonical_template = 'Na frase "{sentence}", qual palavra vem logo depois da palavra "{word}"?'
        self.second_template = 'Na frase "{sentence}", que palavra vem imediatamente após a palavra "{word}"?'
        self.third_template = 'Que palavra está logo depois da palavra "{word}" na frase "{sentence}"?'
