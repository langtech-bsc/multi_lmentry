...
class SentenceContaining(LMentryTask):
    ...
    def __init__(self, name="sentence_containing"):
        super().__init__(name)
        self.canonical_template = 'Escreva uma frase que contenha a palavra "{word}":'
        self.second_template = 'Escreva uma frase usando a palavra "{word}":'
        self.third_template = 'Escreva uma frase com a palavra "{word}":'
