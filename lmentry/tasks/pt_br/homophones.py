...
class Homophones(LMentryTask):
    ...
    def __init__(self, name="homophones"):
        super().__init__(name)
        self.canonical_template = "Que palavra soa como a palavra \"{query}\": \"{word1}\" ou \"{word2}\"?"
        self.second_template = "Dentre estas duas palavras, \"{word1}\" e \"{word2}\", qual tem a pronúncia mais similar à pronúncia de \"{query}\"?"
        self.third_template = "Qual palavra é homófona de \"{query}\": \"{word1}\" ou \"{word2}\"?"
