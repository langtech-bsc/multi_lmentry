...
class RhymingWordOrthographicallySimilar(LMentryTask):
    ...
    def __init__(self, name="rhyming_word_orthographically_similar"):
        super().__init__(name)
        self.canonical_template = "Qual palavra rima com a palavra \"{query}\": \"{word1}\" ou \"{word2}\"?"
        self.second_template = "Qual é uma rima da palavra \"{query}\": \"{word1}\" ou \"{word2}\"?"
        self.third_template = "Das palavras \"{word1}\" e \"{word2}\", qual rima com \"{query}\"?"
