...
class LastWord(LMentryTask):
    ...
    def __init__(self, name="last_word"):
        ...
        self.canonical_template = 'Qual é a última palavra da frase "{sentence}"?'
        self.second_template = 'Na frase "{sentence}", qual é a última palavra?'
        self.third_template = 'Escreva a última palavra da frase "{sentence}":'
