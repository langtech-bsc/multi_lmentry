...
class AllWordsFromCategory2Distractors(LMentryTask):
    ...
    def __init__(self, name="all_words_from_category_2_distractors"):
        ...
        self.canonical_template = 'Todas as palavras {words} são tipos de {category}? Responda exclusivamente com "sim" ou "não".'
        self.second_template = 'Todas estas palavras {words} fazem referência a tipos de {category}? Responda exclusivamente com "sim" ou "não".'
