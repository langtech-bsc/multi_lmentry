...
class FirstWord(LMentryTask):
    ...
    def __init__(self, name="first_word"):
        ...
        self.canonical_template = 'Qual é a primeira palavra da frase "{sentence}"?'
        self.second_template = 'Na frase "{sentence}", qual é a primeira palavra?'
        self.third_template = 'Escreva a primeira palavra da frase "{sentence}":'
