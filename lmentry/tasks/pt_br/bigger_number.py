...
class BiggerNumber(LMentryTask):
    ...
    def __init__(self, name="bigger_number"):
        super().__init__(name)
        self.canonical_template = "Qual número é maior: {n1} ou {n2}?"
        self.second_template = "Dentre os números {n1} e {n2}, qual é maior?"
        self.third_template = "Considerando os números {n1} e {n2}, escreva o número maior:"
