...
class SmallerNumber(LMentryTask):
    ...
    def __init__(self, name="smaller_number"):
        super().__init__(name)
        self.canonical_template = "Qual número é menor: {n1} ou {n2}?"
        self.second_template = "Dentre os números {n1} e {n2}, qual é menor?"
        self.third_template = "Considerando os números {n1} e {n2}, escreva o número menor:"
