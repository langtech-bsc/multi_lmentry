...
class StartsWithWord(LMentryTask):
    ...
    def __init__(self, name="starts_with_word"):
        super().__init__(name)
        self.canonical_template = 'Escreva uma frase que comece com a palavra "{word}":'
        self.second_template = 'Escreva uma frase cuja primeira palavra seja "{word}":'
        self.third_template = 'Escreva uma frase que comece com "{word}":'
