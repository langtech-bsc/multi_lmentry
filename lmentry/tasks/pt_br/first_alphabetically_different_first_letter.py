...
class FirstAlphabeticallyDifferentFirstLetter(LMentryTask):
    ...
    def __init__(self, name="first_alphabetically_different_first_letter", words_path=None):
        super().__init__(name)
        self.canonical_template = "Em ordem alfabética, qual das palavras \"{word1}\" e \"{word2}\" vem primeiro?"
        self.second_template = "Em ordem alfabética, qual palavra vem primeiro: \"{word1}\" ou \"{word2}\"?"
        self.third_template = "Dentre as palavras \"{word1}\" e \"{word2}\", qual vem primeiro alfabeticamente?"
