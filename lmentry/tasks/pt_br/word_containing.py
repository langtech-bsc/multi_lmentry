...
class WordContaining(LMentryTask):
    ...
    def __init__(self, name="word_containing"):
        super().__init__(name)
        self.canonical_template = 'Escreva uma palavra que contenha a letra "{letter}":'
        self.second_template = 'Escreva uma palavra usando a letra "{letter}":'
        self.third_template = 'Escreva uma palavra com a letra "{letter}":'
