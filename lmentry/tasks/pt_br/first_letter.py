...
class FirstLetter(LMentryTask):
    ...
    def __init__(self, name="first_letter"):
        ...
        self.canonical_template = 'Qual é a primeira letra da palavra "{word}"?'
        self.second_template = 'Com que letra começa a palavra "{word}"?'
        self.third_template = 'Escreva a primeira letra da palavra "{word}":'
