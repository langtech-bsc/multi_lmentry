...
class SentenceNotContaining(LMentryTask):
    ...
    def __init__(self, name="sentence_not_containing"):
        super().__init__(name)
        self.canonical_template = 'Escreva uma frase que não contenha a palavra "{word}":'
        self.second_template = 'Escreva uma frase sem usar a palavra "{word}":'
        self.third_template = 'Escreva uma frase sem a palavra "{word}":'
