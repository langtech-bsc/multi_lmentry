...
class SentenceContaining(LMentryTask):
    ...
    def __init__(self, name="sentence_containing"):
        super().__init__(name)
        self.canonical_template = 'Escriu una frase que contingui la paraula "{word}":'
        self.second_template = 'Escriu una frase utilitzant la paraula "{word}":'
        self.third_template = 'Escriu una frase amb la paraula "{word}":'
