...
class RhymingWord(LMentryTask):
    ...
    def __init__(self, name="rhyming_word"):
        ...
        self.canonical_template = "Quina paraula rima amb la paraula \"{query}\": \"{word1}\" o \"{word2}\"?"
        self.second_template = "Quina és una rima de la paraula \"{query}\": \"{word1}\" o \"{word2}\"?"
        self.third_template = "De les paraules \"{word1}\" i \"{word2}\", quina rima amb \"{query}\"?"
