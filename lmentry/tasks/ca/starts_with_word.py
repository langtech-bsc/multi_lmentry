...
class StartsWithWord(LMentryTask):
    ...
    def __init__(self, name="starts_with_word"):
        super().__init__(name)
        self.canonical_template = 'Escriu una frase que comenci amb la paraula "{word}":'
        self.second_template = 'Escriu una frase la primera paraula de la qual sigui "{word}":'
        self.third_template = 'Escriu una frase que comenci amb "{word}":'
