...
class LeastAssociatedWord(LMentryTask):
    ...
    def __init__(self, name="least_associated_word"):
        ...
        self.canonical_template = \
            "D'entre les paraules {options}, quina és la paraula menys relacionada amb '{category}'?"
        self.second_template = \
            "Quina paraula està menys relacionada amb '{category}' d'entre les paraules {options}?"
        self.third_template = \
            "D'entre les paraules següents, escull la paraula menys relacionada amb '{category}' - {options}:"
