...
class Homophones(LMentryTask):
    ...
    def __init__(self, name="homophones"):
        super().__init__(name)
        self.canonical_template = "Quina paraula es pronuncia com la paraula \"{query}\": \"{word1}\" o \"{word2}\"?"
        self.second_template = "D'entre les paraules \"{word1}\" i \"{word2}\", quina es pronuncia de manera més similar a \"{query}\"?"
        self.third_template = "Quina paraula és homòfona de \"{query}\": \"{word1}\" o \"{word2}\"?"
