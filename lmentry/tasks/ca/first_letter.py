...
class FirstLetter(LMentryTask):
    ...
    def __init__(self, name="first_letter"):
        ...
        self.canonical_template = 'Quina és la primera lletra de la paraula "{word}"?'
        self.second_template = 'Amb quina lletra comença la paraula "{word}"?'
        self.third_template = 'Escriu la primera lletra de la paraula "{word}":'
