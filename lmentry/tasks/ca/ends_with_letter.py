...
class EndsWithLetter(LMentryTask):
    ...
    def __init__(self, name="ends_with_letter"):
        ...
        self.canonical_template = "Escriu una paraula que acabi amb la lletra '{letter}':"
        self.second_template = "Escriu una paraula l'última lletra de la qual sigui '{letter}':"
        self.third_template = "Escriu una paraula que acabi en '{letter}':"
    ...
    def create_data(self, task_data_path=None):
        ...
        allowed_letters = set(ca_letters) - {"h", "j", "k", "q", "v", "w", "z"}
