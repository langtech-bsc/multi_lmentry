...
class SmallerNumber(LMentryTask):
    ...
    def __init__(self, name="smaller_number"):
        super().__init__(name)
        self.canonical_template = "Quin nombre és més petit: {n1} o {n2}?"
        self.second_template = "D'entre els nombres {n1} i {n2}, quin és més petit?"
        self.third_template = "D'entre els nombres {n1} i {n2}, escriu el nombre més petit:"
