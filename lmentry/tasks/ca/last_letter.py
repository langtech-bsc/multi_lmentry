...
class LastLetter(LMentryTask):
    ...
    def __init__(self, name="last_letter"):
        ...
        self.canonical_template = "Quina és l'última lletra de la paraula '{word}'?"
        self.second_template = 'Amb quina lletra acaba la paraula "{word}"?'
        self.third_template = "Escriu l'última lletra de la paraula '{word}':"
