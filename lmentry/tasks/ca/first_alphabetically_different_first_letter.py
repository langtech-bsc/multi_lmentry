...
class FirstAlphabeticallyDifferentFirstLetter(LMentryTask):
    ...
    def __init__(self, name="first_alphabetically_different_first_letter", words_path=None):
        super().__init__(name)
        self.canonical_template = "En ordre alfabètic, quina de les paraules \"{word1}\" i \"{word2}\" va primer?"
        self.second_template = "En ordre alfabètic, quina paraula va primer: \"{word1}\" o \"{word2}\"?"
        self.third_template = "De les paraules \"{word1}\" i \"{word2}\", quina va primer alfabèticament?"
