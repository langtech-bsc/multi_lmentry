...
class WordBefore(LMentryTask):
    ...
    def __init__(self, name="word_before"):
        ...
        self.canonical_template = 'A la frase "{sentence}", quina paraula ve just abans de la paraula "{word}"?'
        self.second_template = 'A la frase "{sentence}", quina paraula precedeix a la paraula "{word}"?'
        self.third_template = 'Quina paraula va just abans de "{word}" a la frase "{sentence}"?'
