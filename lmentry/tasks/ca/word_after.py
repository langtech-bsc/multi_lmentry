...
class WordAfter(LMentryTask):
    ...
    def __init__(self, name="word_after"):
        ...
        self.canonical_template = 'A la frase "{sentence}", quina paraula ve just després de la paraula "{word}"?'
        self.second_template = 'A la frase "{sentence}", quina paraula hi ha immediatament després de la paraula "{word}"?'
        self.third_template = 'Quina paraula va just després de "{word}" a la frase "{sentence}"?'
