...
class FirstWord(LMentryTask):
    ...
    def __init__(self, name="first_word"):
        ...
        self.canonical_template = 'Quina és la primera paraula de la frase "{sentence}"?'
        self.second_template = 'A la frase "{sentence}", quina és la primera paraula?'
        self.third_template = 'Escriu la primera paraula de la frase "{sentence}":'
