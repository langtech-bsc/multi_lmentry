...
class EndsWithWord(LMentryTask):
    ...
    def __init__(self, name="ends_with_word"):
        super().__init__(name)
        self.canonical_template = 'Escriu una frase que acabi amb la paraula "{word}":'
        self.second_template = "Escriu una frase l'última paraula de la qual sigui '{word}':"
        self.third_template = 'Escriu una frase que acabi en "{word}":'
