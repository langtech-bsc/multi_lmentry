...
class LastWord(LMentryTask):
    ...
    def __init__(self, name="last_word"):
        ...
        self.canonical_template = "Quina és l'última paraula de la frase '{sentence}'?"
        self.second_template = "A la frase '{sentence}', quina és l'última paraula?"
        self.third_template = "Escriu l'última paraula de la frase '{sentence}':"
