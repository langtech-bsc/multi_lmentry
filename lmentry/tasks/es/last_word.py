...
class LastWord(LMentryTask):
    ...
    def __init__(self, name="last_word"):
        ...
        self.canonical_template = '¿Cuál es la última palabra de la frase "{sentence}"?'
        self.second_template = 'En la frase "{sentence}", ¿cuál es la última palabra?'
        self.third_template = 'Escribe la última palabra de la frase "{sentence}":'
