...
class AllWordsFromCategory2Distractors(LMentryTask):
    ...
    def __init__(self, name="all_words_from_category_2_distractors"):
        ...
        self.canonical_template = '¿Son todas las palabras {words} tipos de {category}? Responde exclusivamente con "sí" o "no".'
        self.second_template = '¿Hacen referencia todas estas palabras {words} a tipos de {category}? Responde exclusivamente con "sí" o "no".'
        self.third_template = '¿Contiene la lista [{words}] exclusivamente tipos de {category}? Responde exclusivamente con "sí" o "no".'
