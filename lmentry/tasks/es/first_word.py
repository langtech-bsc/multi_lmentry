...
class FirstWord(LMentryTask):
    ...
    def __init__(self, name="first_word"):
        ...
        self.canonical_template = '¿Cuál es la primera palabra de la frase "{sentence}"?'
        self.second_template = 'En la frase "{sentence}", ¿cuál es la primera palabra?'
        self.third_template = 'Escribe la primera palabra de la frase "{sentence}":'
