...
class Homophones(LMentryTask):
    ...
    def __init__(self, name="homophones"):
        super().__init__(name)
        self.canonical_template = "¿Qué palabra suena como la palabra \"{query}\": \"{word1}\" o \"{word2}\"?"
        self.second_template = "De las dos palabras \"{word1}\" y \"{word2}\", ¿cuál suena más como \"{query}\"?"
        self.third_template = "¿Qué palabra es homófona de \"{query}\": \"{word1}\" o \"{word2}\"?"
