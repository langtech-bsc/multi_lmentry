...
class StartsWithWord(LMentryTask):
    ...
    def __init__(self, name="starts_with_word"):
        super().__init__(name)
        self.canonical_template = 'Escribe una frase que empiece con la palabra "{word}":'
        self.second_template = 'Escribe una frase cuya primera palabra sea "{word}":'
        self.third_template = 'Escribe una frase que empiece con "{word}":'
