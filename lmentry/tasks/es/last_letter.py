...
class LastLetter(LMentryTask):
    ...
    def __init__(self, name="last_letter"):
        ...
        self.canonical_template = '¿Cuál es la última letra de la palabra "{word}"?'
        self.second_template = '¿Con qué letra termina la palabra "{word}"?'
        self.third_template = 'Escribe la última letra de la palabra "{word}":'
