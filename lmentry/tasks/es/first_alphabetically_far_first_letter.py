...
class FirstAlphabeticallyFarFirstLetter(LMentryTask):
    ...
    def __init__(self, name="first_alphabetically_far_first_letter", words_path=None):
        super().__init__(name)
        self.canonical_template = "En orden alfabético, ¿cuál de las palabras \"{word1}\" y \"{word2}\" va primero?"
        self.second_template = "En orden alfabético, ¿qué palabra va primero: \"{word1}\" o \"{word2}\"?"
        self.third_template = "De las palabras \"{word1}\" y \"{word2}\", ¿cuál viene primero alfabéticamente?"
