...
class LessLettersLengthDiff1(LMentryTask):
    ...
    def __init__(self, name="less_letters_length_diff_1"):
        ...
        self.canonical_template = '¿Qué palabra tiene menos letras: "{word1}" o "{word2}"?'
        self.second_template = '¿Qué palabra es más corta: "{word1}" o "{word2}"?'
        self.third_template = 'De las palabras "{word1}" y "{word2}", ¿cuál tiene menos letras?'
