...
class WordNotContaining(LMentryTask):
    ...
    def __init__(self, name="word_not_containing"):
        super().__init__(name)
        self.canonical_template = 'Escribe una palabra que no contenga la letra "{letter}":'
        self.second_template = 'Escribe una palabra sin usar la letra "{letter}":'
        self.third_template = 'Escribe una palabra sin la letra "{letter}":'
