...
class EndsWithLetter(LMentryTask):
    ...
    def __init__(self, name="ends_with_letter"):
        ...
        self.canonical_template = 'Escribe una palabra que termine con la letra "{letter}":'
        self.second_template = 'Escribe una palabra cuya última letra sea "{letter}":'
        self.third_template = 'Escribe una palabra que termine en "{letter}":'
    ...
    def create_data(self, task_data_path=None):
        ...
        es_letters = set(letters) | {"ñ"}
        allowed_letters = set(es_letters) - {"c", "h", "k", "ñ", "p", "q", "u", "v", "w", "x"}
