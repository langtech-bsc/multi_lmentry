...
class SentenceContaining(LMentryTask):
    ...
    def __init__(self, name="sentence_containing"):
        super().__init__(name)
        self.canonical_template = 'Escribe una frase que contenga la palabra "{word}":'
        self.second_template = 'Escribe una frase usando la palabra "{word}":'
        self.third_template = 'Escribe una frase con la palabra "{word}":'
