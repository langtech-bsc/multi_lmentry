...
class SentenceNotContaining(LMentryTask):
    ...
    def __init__(self, name="sentence_not_containing"):
        super().__init__(name)
        self.canonical_template = 'Escribe una frase que no contenga la palabra "{word}":'
        self.second_template = 'Escribe una frase sin usar la palabra "{word}":'
        self.third_template = 'Escribe una frase sin la palabra "{word}":'
