...
class LeastAssociatedWord(LMentryTask):
    ...
    def __init__(self, name="least_associated_word"):
        ...
        self.canonical_template = \
            'De las palabras {options}, ¿cuál es la palabra menos asociada con "{category}"?'
        self.second_template = \
            '¿Qué palabra es la menos relacionada con "{category}" entre las palabras {options}?'
        self.third_template = \
            'Entre las siguientes palabras, elige la palabra menos asociada con "{category}" - {options}:'
