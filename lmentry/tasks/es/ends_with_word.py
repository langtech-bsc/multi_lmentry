...
class EndsWithWord(LMentryTask):
    ...
    def __init__(self, name="ends_with_word"):
        super().__init__(name)
        self.canonical_template = 'Escribe una frase que termine con la palabra "{word}":'
        self.second_template = 'Escribe una frase cuya última palabra sea "{word}":'
        self.third_template = 'Escribe una frase que acabe con "{word}":'
