...
class StartsWithLetter(LMentryTask):
    ...
    def __init__(self, name="starts_with_letter"):
        ...
        self.canonical_template = 'Escribe una palabra que empiece con la letra "{letter}":'
        self.second_template = 'Escribe una palabra cuya primera letra sea "{letter}":'
        self.third_template = 'Escribe una palabra que empiece en "{letter}":'
    ...
    def create_data(self, task_data_path=None):
        ...
        allowed_letters = set(es_letters) - {"k", "w", "x"}
