...
class WordBefore(LMentryTask):
    ...
    def __init__(self, name="word_before"):
        ...
        self.canonical_template = 'En la frase "{sentence}", ¿qué palabra viene justo antes de la palabra "{word}"?'
        self.second_template = 'En la frase "{sentence}", ¿qué palabra precede a la palabra "{word}"?'
        self.third_template = '¿Qué palabra va justo antes de "{word}" en la frase "{sentence}"?'
