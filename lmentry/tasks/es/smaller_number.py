...
class SmallerNumber(LMentryTask):
    ...
    def __init__(self, name="smaller_number"):
        super().__init__(name)
        self.canonical_template = "¿Qué número es más pequeño: {n1} o {n2}?"
        self.second_template = "Entre los números {n1} y {n2}, ¿cuál es más pequeño?"
        self.third_template = "De los números {n1} y {n2}, escribe el número más pequeño:"
