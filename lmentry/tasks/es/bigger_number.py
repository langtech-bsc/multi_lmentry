...
class BiggerNumber(LMentryTask):
    ...
    def __init__(self, name="bigger_number"):
        super().__init__(name)
        self.canonical_template = "¿Qué número es más grande: {n1} o {n2}?"
        self.second_template = "Entre los números {n1} y {n2}, ¿cuál es más grande?"
        self.third_template = "De los números {n1} y {n2}, escribe el número más grande:"
