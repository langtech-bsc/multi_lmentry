...
class WordAfter(LMentryTask):
    ...
    def __init__(self, name="word_after"):
        ...
        self.canonical_template = 'En la frase "{sentence}", ¿qué palabra viene justo después de la palabra "{word}"?'
        self.second_template = 'En la frase "{sentence}", ¿qué palabra hay inmediatamente después de la palabra "{word}"?'
        self.third_template = '¿Qué palabra va justo después de "{word}" en la frase "{sentence}"?'
