...
class RhymingWord(LMentryTask):
    ...
    def __init__(self, name="rhyming_word"):
        super().__init__(name)
        self.canonical_template = "¿Qué palabra rima con la palabra \"{query}\": \"{word1}\" o \"{word2}\"?"
        self.second_template = "¿Cuál es una rima de la palabra \"{query}\": \"{word1}\" o \"{word2}\"?"
        self.third_template = "De las palabras \"{word1}\" y \"{word2}\", ¿cuál rima con \"{query}\"?"
