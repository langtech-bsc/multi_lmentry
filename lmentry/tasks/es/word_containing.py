...
class WordContaining(LMentryTask):
    ...
    def __init__(self, name="word_containing"):
        super().__init__(name)
        self.canonical_template = 'Escribe una palabra que contenga la letra "{letter}":'
        self.second_template = 'Escribe una palabra usando la letra "{letter}":'
        self.third_template = 'Escribe una palabra con la letra "{letter}":'
