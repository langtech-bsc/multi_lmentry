...
class EndsWithLetter(LMentryTask):
    ...
    def __init__(self, name="ends_with_letter"):
        ...
        self.canonical_template = 'Schreibe ein Wort, das mit dem Buchstaben "{letter}" aufhört:'
        self.second_template = 'Schreibe ein Wort, dessen letzter Buchstabe "{letter}" ist:'
        self.third_template = 'Schreibe ein Wort, das auf "{letter}" endet:'
    ...
    def create_data(self, task_data_path=None):
        ...
        allowed_letters = set(de_letters) - {"c", "j", "q", "w", "ä", "ö"}
