...
class MoreLettersLengthDiff1(LMentryTask):
    ...
    def __init__(self, name="more_letters_length_diff_1"):
        ...
        self.canonical_template = 'Welches Wort hat mehr Buchstaben: "{word1}" oder "{word2}"?'
        self.second_template = 'Welches Wort ist länger: "{word1}" oder "{word2}"?'
        self.third_template = 'Zwischen den Wörtern "{word1}" und "{word2}", welches hat mehr Buchstaben?'
