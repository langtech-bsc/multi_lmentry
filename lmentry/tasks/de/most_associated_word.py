...
class MostAssociatedWord(LMentryTask):
    ...
    def __init__(self, name="most_associated_word"):
        ...
        self.canonical_template = \
            'Welches der Wörter {options} wird am häufigsten mit der Kategorie "{category}" assoziiert?'
        self.second_template = \
            'Welches der Wörter {options} ist am meisten mit der Kategorie "{category}" verwandt?'
        self.third_template = \
            'Wähle aus den folgenden Wörtern das Wort aus, das am meisten mit der Kategorie "{category}" assoziiert wird - {options}:'
