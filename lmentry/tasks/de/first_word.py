...
class FirstWord(LMentryTask):
    ...
    def __init__(self, name="first_word"):
        ...
        self.canonical_template = 'Was ist das erste Wort des Satzes "{sentence}"?'
        self.second_template = 'Mit welchem Wort fängt der Satz "{sentence}" an?'
        self.third_template = 'Schreibe das erste Wort des Satzes "{sentence}":'
