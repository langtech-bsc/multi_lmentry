...
class BiggerNumber(LMentryTask):
    ...
    def __init__(self, name="bigger_number"):
        super().__init__(name)
        self.canonical_template = "Welche Zahl ist größer: {n1} oder {n2}?"
        self.second_template = "Welche der Zahlen {n1} und {n2} ist größer?"
        self.third_template = "Von den Zahlen {n1} and {n2}, schreibe die größere Zahl:"
