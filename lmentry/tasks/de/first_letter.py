...
class FirstLetter(LMentryTask):
    ...
    def __init__(self, name="first_letter"):
        ...
        self.canonical_template = 'Was ist der erste Buchstabe des Wortes "{word}"?'
        self.second_template = 'Mit welchem Buchstaben beginnt das Wort "{word}"?'
        self.third_template = 'Schreibe den ersten Buchstaben des Wortes "{word}":'
