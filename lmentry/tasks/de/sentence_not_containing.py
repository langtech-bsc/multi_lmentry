...
class SentenceNotContaining(LMentryTask):
    ...
    def __init__(self, name="sentence_not_containing"):
        super().__init__(name)
        self.canonical_template = 'Schreibe einen Satz, der das Wort "{word}" nicht enthält:'
        self.second_template = 'Schreibe einen Satz, ohne das Wort "{word} zu benutzen":'
        self.third_template = 'Schreibe einen Satz ohne das Wort "{word}":'
