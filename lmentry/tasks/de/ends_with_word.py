...
class EndsWithWord(LMentryTask):
    ...
    def __init__(self, name="ends_with_word"):
        super().__init__(name)
        self.canonical_template = 'Schreibe einen Satz, der mit dem Wort "{word}" aufhört:'
        self.second_template = 'Schreibe einen Satz, dessen letztes Wort "{word}" ist:'
        self.third_template = 'Schreibe einen Satz, der mit "{word}" endet:'
