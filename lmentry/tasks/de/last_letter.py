...
class LastLetter(LMentryTask):
    ...
    def __init__(self, name="last_letter"):
        ...
        self.canonical_template = 'Was ist der letzte Buchstabe des Wortes "{word}"?'
        self.second_template = 'Auf welchen Buchstaben endet das Wort "{word}"?'
        self.third_template = 'Schreibe den letzten Buchstaben des Wortes  "{word}":'
