...
class WordBefore(LMentryTask):
    ...
    def __init__(self, name="word_before"):
        ...
        self.canonical_template = 'Im Satz "{sentence}", welches Wort kommt direkt vor dem Wort "{word}"?'
        self.second_template = 'Im Satz "{sentence}", welches Wort geht dem Wort "{word}" unmittelbar voraus?'
        self.third_template = 'Welches Wort steht direkt vor "{word}" im Satz "{sentence}"?'
