...
class StartsWithWord(LMentryTask):
    ...
    def __init__(self, name="starts_with_word"):
        super().__init__(name)
        self.canonical_template = 'Schreibe einen Satz, der mit dem Wort "{word}" beginnt:'
        self.second_template = 'Schreibe einen Satz, dessen erstes Wort "{word}" ist:'
        self.third_template = 'Schreibe einen Satz, der mit "{word}" anfängt:'
