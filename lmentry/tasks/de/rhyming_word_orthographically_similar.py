...
class RhymingWordOrthographicallySimilar(LMentryTask):
    ...
    def __init__(self, name="rhyming_word_orthographically_similar"):
        super().__init__(name)
        self.canonical_template = "Welches Wort reimt sich mit dem Wort \"{query}\": \"{word1}\" oder \"{word2}\"?"
        self.second_template = "Welches ist ein Reim auf das Wort \"{query}\": \"{word1}\" oder \"{word2}\"?"
        self.third_template = "Zwischen den Wörtern \"{word1}\" und \"{word2}\", welches reimt sich mit \"{query}\"?"
