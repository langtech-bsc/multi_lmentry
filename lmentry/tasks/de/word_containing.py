...
class WordContaining(LMentryTask):
    ...
    def __init__(self, name="word_containing"):
        super().__init__(name)
        self.canonical_template = 'Schreibe ein Wort, das den Buchstaben "{letter}" enthält:'
        self.second_template = 'Schreibe ein Wort und benutze den Buchstaben "{letter}":'
        self.third_template = 'Schreibe ein Wort mit dem Buchstaben "{letter}":'
