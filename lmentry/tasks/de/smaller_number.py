...
class SmallerNumber(LMentryTask):
    ...
    def __init__(self, name="smaller_number"):
        super().__init__(name)
        self.canonical_template = "Welche Zahl ist kleiner: {n1} oder {n2}?"
        self.second_template = "Welche der Zahlen {n1} und {n2} ist kleiner?"
        self.third_template = "Schreibe die kleinere der Zahlen {n1} und {n2}:"
