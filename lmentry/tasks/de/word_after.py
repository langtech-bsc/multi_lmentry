...
class WordAfter(LMentryTask):
    ...
    def __init__(self, name="word_after"):
        ...
        self.canonical_template = 'Im Satz "{sentence}", welches Wort kommt gleich nach dem Wort "{word}"?'
        self.second_template = 'Im Satz "{sentence}", welches Wort folgt direkt auf das Wort "{word}"?'
        self.third_template = 'Welches Wort steht direkt hinter "{word}" im Satz "{sentence}"?'
