...
class LessLettersLengthDiff3plus(LMentryTask):
    ...
    def __init__(self, name="less_letters_length_diff_3plus"):
        ...
        self.canonical_template = 'Welches Wort hat weniger Buchstaben: "{word1}" oder "{word2}"?'
        self.second_template = 'Welches Wort ist kürzer: "{word1}" oder "{word2}"?'
        self.third_template = 'Zwischen den Wörtern "{word1}" und "{word2}", welches hat weniger Buchstaben?'
