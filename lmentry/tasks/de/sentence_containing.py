...
class SentenceContaining(LMentryTask):
    ...
    def __init__(self, name="sentence_containing"):
        super().__init__(name)
        self.canonical_template = 'Schreibe einen Satz, der das Wort "{word}" enthält:'
        self.second_template = 'Schreibe einen Satz und benutze das Wort "{word}":'
        self.third_template = 'Schreibe einen Satz mit dem Wort "{word}":'
