...
class AllWordsFromCategory1Distractors(LMentryTask):
    ...
    def __init__(self, name="all_words_from_category_1_distractors"):
        ...
        self.canonical_template = 'Sind alle Wörter {words} {category}? Antworte entweder mit "ja" oder "nein".'
        self.second_template = 'Repräsentieren die Worte {words} alle {category}? Antworte entweder mit "ja" oder "nein".'
        self.third_template = 'Enthält die Liste [{words}] nur {category}? Antworte entweder mit "ja" oder "nein".'
