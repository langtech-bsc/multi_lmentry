...
class AnyWordsFromCategory3Distractors(LMentryTask):
    ...
    def __init__(self, name="any_words_from_category_3_distractors"):
        ...
        self.canonical_template = 'آیا هیچ یک از کلمات {words} از نوع {category} هستند؟ با «بله» یا «خیر» پاسخ دهید.'
        self.second_template = 'آیا هیچ یک از کلمات {words} نشان دهنده {category} هستند؟ با «بله» یا «خیر» پاسخ دهید.'
        self.third_template = 'آیا لیست [{words}] شامل هیچ {category} است؟ با «بله» یا «خیر» پاسخ دهید'
