...
class LeastAssociatedWord(LMentryTask):
    ...
    def __init__(self, name="least_associated_word"):
        ...
        self.canonical_template = \
            'از بین کلمات {options}، کدام کلمه کمترین ارتباط را با "{category}" دارد؟'
        self.second_template = \
            'از بین کلمات {options} کدام کلمه کمترین ارتباط را با کلمه "{category}" دارد؟'
        self.third_template = \
            'از بین کلمات زیر، کلمه‌ای را انتخاب کنید که کمترین ارتباط را با کلمه "{category}" دارد - {options}'
