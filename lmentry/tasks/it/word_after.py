...
class WordAfter(LMentryTask):
    ...
    def __init__(self, name="word_after"):
        ...
        self.canonical_template = 'Nella frase "{sentence}", quale parola viene subito dopo la parola "{word}"?'
        self.second_template = 'Nella frase "{sentence}", quale parola segue immediatamente la parola "{word}"?'
        self.third_template = 'Quale parola viene subito dopo "{word}" nella frase "{sentence}"?'
