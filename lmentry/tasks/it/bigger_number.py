...
class BiggerNumber(LMentryTask):
    ...
    def __init__(self, name="bigger_number"):
        super().__init__(name)
        self.canonical_template = "Quale numero è più grande: {n1} o {n2}?"
        self.second_template = "Tra i numeri {n1} e {n2}, qual è più grande?"
        self.third_template = "Tra i numeri {n1} e {n2}, scrivi il numero più grande:"
