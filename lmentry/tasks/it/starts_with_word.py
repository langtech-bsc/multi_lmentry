...
from lmentry.scorers.it.starts_with_word_scorer import StartsWithWordScorer
...
class StartsWithWord(LMentryTask):
    ...
    def __init__(self, name="starts_with_word"):
        super().__init__(name)
        self.canonical_template = 'Scrivi una frase che inizia con la parola "{word}":'
        self.second_template = 'Scrivi una frase la cui prima parola è "{word}":'
        self.third_template = 'Scrivi una frase che comincia con "{word}":'
