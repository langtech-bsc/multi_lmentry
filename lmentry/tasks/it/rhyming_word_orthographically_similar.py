...
class RhymingWordOrthographicallySimilar(LMentryTask):
    ...
    def __init__(self, name="rhyming_word_orthographically_similar"):
        super().__init__(name)
        self.canonical_template = "Quale parola fa rima con la parola \"{query}\": \"{word1}\" o \"{word2}\"?"
        self.second_template ="Qual è una rima della parola \"{query}\": \"{word1}\" o \"{word2}\"?"
        self.third_template = "Tra le parole \"{word1}\" e \"{word2}\", quale fa rima con \"{query}\"?"
