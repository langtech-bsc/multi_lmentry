...
from lmentry.scorers.it.last_letter_scorer import LastLetterScorer
...
class LastLetter(LMentryTask):
    ...
    def __init__(self, name="last_letter"):
        ...
        self.canonical_template = "Qual è l'ultima lettera della parola '{word}'?"
        self.second_template = 'Con quale lettera termina la parola "{word}"?'
        self.third_template = "Scrivi l'ultima lettera della parola '{word}':"
