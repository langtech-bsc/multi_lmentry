...
class WordContaining(LMentryTask):
    ...
    def __init__(self, name="word_containing"):
        super().__init__(name)
        self.canonical_template = 'Scrivi una parola che contiene la lettera "{letter}":'
        self.second_template = 'Scrivi una parola usando la lettera "{letter}":'
        self.third_template = 'Scrivi una parola contenente la lettera "{letter}":'
