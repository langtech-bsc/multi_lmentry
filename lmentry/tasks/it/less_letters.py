...
class LessLetters(LMentryTask):
    ...
    def __init__(self, name="less_letters"):
        ...
        self.canonical_template = 'Quale parola ha meno lettere: "{word1}" o "{word2}"?'
        self.second_template = 'Quale parola è più corta: "{word1}" o "{word2}"?'
        self.third_template = 'Tra le parole "{word1}" e "{word2}" quale ha meno lettere?'
