...
class StartsWithLetter(LMentryTask):
    ...
    def __init__(self, name="starts_with_letter"):
        ...
        self.canonical_template = 'Scrivi una parola che inizia con la lettera "{letter}":'
        self.second_template = 'Scrivi una parola la cui prima lettera è "{letter}":'
        self.third_template = 'Scrivi una parola che comincia con "{letter}":'
