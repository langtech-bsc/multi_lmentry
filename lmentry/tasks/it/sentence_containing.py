...
class SentenceContaining(LMentryTask):
    ...
    def __init__(self, name="sentence_containing"):
        super().__init__(name)
        self.canonical_template = 'Scrivi una frase che contiene la parola "{word}":'
        self.second_template = 'Scrivi una frase usando la parola "{word}":'
        self.third_template = 'Scrivi una frase contenente la parola "{word}":'
