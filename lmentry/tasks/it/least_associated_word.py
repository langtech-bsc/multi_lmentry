...
from lmentry.scorers.it.least_associated_word_scorer import LeastAssociatedWordScorer
...
class LeastAssociatedWord(LMentryTask):
    ...
    def __init__(self, name="least_associated_word"):
        ...
        self.canonical_template = \
            'Delle parole {options}, qual è la parola meno associata con "{category}"?'
        self.second_template = \
            'Qual è la parola meno correlata con la categoria "{category}" tra le parole {options}?'
        self.third_template = \
            'Tra le seguenti parole, scegli la parola meno associata con la categoria "{category}" - {options}:'
