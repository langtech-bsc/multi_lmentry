...
class LastWord(LMentryTask):
    ...
    def __init__(self, name="last_word"):
        ...
        self.canonical_template = "Qual è l'ultima parola nella frase '{sentence}'?"
        self.second_template = "Nella frase '{sentence}', qual è l'ultima parola?"
        self.third_template = "Scrivi l'ultima parola nella frase '{sentence}':"
