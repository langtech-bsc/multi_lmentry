...
class EndsWithLetter(LMentryTask):
    ...
    def __init__(self, name="ends_with_letter"):
        ...
        self.canonical_template = 'Scrivi una parola che termina con la lettera "{letter}":'
        self.second_template = 'Scrivi una parola la cui ultima lettera è "{letter}":'
        self.third_template = 'Scrivi una parola che finisce con "{letter}":'
