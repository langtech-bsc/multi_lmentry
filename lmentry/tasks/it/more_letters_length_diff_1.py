...
from lmentry.scorers.it.more_letters_scorer import MoreLettersScorer
...
class MoreLettersLengthDiff1(LMentryTask):
    ...
    def __init__(self, name="more_letters_length_diff_1"):
        ...
        self.canonical_template = 'Quale parola ha più lettere: "{word1}" o "{word2}"?'
        self.second_template = 'Quale parola è più lunga: "{word1}" o "{word2}"?'
        self.third_template = 'Tra le parole "{word1}" e "{word2}" quale ha più lettere?'
