...
class Homophones(LMentryTask):
    ...
    def __init__(self, name="homophones"):
        super().__init__(name)
        self.canonical_template = "Quale parola si pronuncia come la parola \"{query}\": \"{word1}\" o \"{word2}\"?"
        self.second_template = "Tra le due parole \"{word1}\" e \"{word2}\", quale si pronuncia in maniera più simile a \"{query}\"?"
        self.third_template = "Qual è un omofono della parola \"{query}\": \"{word1}\" o \"{word2}\"?"
