...
from lmentry.scorers.it.first_word_scorer import FirstWordScorer
...
class FirstWord(LMentryTask):
    ...
    def __init__(self, name="first_word"):
        ...
        self.canonical_template = 'Qual è la prima parola della frase "{sentence}"?'
        self.second_template = 'Nella frase "{sentence}", qual è la prima parola?'
        self.third_template = 'Scrivi la prima parola nella frase "{sentence}":'
