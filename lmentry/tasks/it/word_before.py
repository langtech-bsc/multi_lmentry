...
class WordBefore(LMentryTask):
    ...
    def __init__(self, name="word_before"):
        ...
        self.canonical_template = 'Nella frase "{sentence}", quale parola viene subito prima della parola "{word}"?'
        self.second_template = 'Nella frase "{sentence}", quale parola precede immediatamente la parola "{word}"?'
        self.third_template = 'Quale parola viene subito prima "{word}" nella frase "{sentence}"?'
