...
class EndsWithWord(LMentryTask):
    ...
    def __init__(self, name="ends_with_word"):
        super().__init__(name)
        self.canonical_template = 'Scrivi una frase che termina con la parola "{word}":'
        self.second_template = 'Scrivi una frase la cui ultima parola è "{word}":'
        self.third_template = 'Scrivi una frase che finisce con "{word}":'
