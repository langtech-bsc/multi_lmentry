...
from lmentry.scorers.it.most_associated_word_scorer import MostAssociatedWordScorer
...
class MostAssociatedWord(LMentryTask):
    ...
    def __init__(self, name="most_associated_word"):
        ...
        self.canonical_template = \
            'Delle parole {options}, qual è la parola più comunemente associata con "{category}"?'
        self.second_template = \
            'Qual è la parola più correlata con la categoria "{category}" tra le parole {options}?'
        self.third_template = \
            'Tra le seguenti parole, scegli la parola più comunemente associata con la categoria "{category}" - {options}:'
