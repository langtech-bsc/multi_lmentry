...
class WordNotContaining(LMentryTask):
    ...
    def __init__(self, name="word_not_containing"):
        super().__init__(name)
        self.canonical_template = 'Scrivi una parola che non contiene la lettera "{letter}":'
        self.second_template = 'Scrivi una parola non usando la lettera "{letter}":'
        self.third_template = 'Scrivi una parola non contenente la lettera "{letter}":'
