...
from lmentry.scorers.it.sentence_not_containing_scorer import SentenceNotContainingScorer
...
class SentenceNotContaining(LMentryTask):
    ...
    def __init__(self, name="sentence_not_containing"):
        super().__init__(name)
        self.canonical_template = 'Scrivi una frase che non contiene la parola "{word}":'
        self.second_template = 'Scrivi una frase non usando la parola "{word}":'
        self.third_template = 'Scrivi una frase non contenente la parola "{word}":'
