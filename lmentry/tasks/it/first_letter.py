...
class FirstLetter(LMentryTask):
    ...
    def __init__(self, name="first_letter"):
        ...
        self.canonical_template = 'Qual è la prima lettera della parola "{word}"?'
        self.second_template = 'Con quale lettera inizia la parola "{word}"?'
        self.third_template = 'Scrivi la prima lettera della parola "{word}":'
