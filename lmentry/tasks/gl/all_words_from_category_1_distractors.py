...
from lmentry.scorers.gl.all_words_from_category_scorer import AllWordsFromCategoryScorer
...
class AllWordsFromCategory1Distractors(LMentryTask):
    ...
    def __init__(self, name="all_words_from_category_1_distractors"):
        ...
        self.canonical_template = 'Son tódalas palabras {words} do tipo {category}? Responde "si" ou "non".'
        self.second_template = 'Das palabras {words} todas representan {category}? Responde "si" ou "non".'
        self.third_template = 'A seguinte lista [{words}] contén só {category}? Responde "si" ou "non".'
