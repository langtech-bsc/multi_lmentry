...
from lmentry.scorers.gl.last_word_scorer import LastWordScorer
...
class LastWord(LMentryTask):
    ...
    def __init__(self, name="last_word"):
        ...
        self.canonical_template = 'Cal é a última palabra da oración "{sentence}"?'
        self.second_template = 'Na oración "{sentence}", cal é a última palabra?'
        self.third_template = 'Escribe a última palabra da oración "{sentence}":'
