...
from lmentry.scorers.gl.word_containing_scorer import WordContainingScorer
...
class WordContaining(LMentryTask):
    ...
    def __init__(self, name="word_containing"):
        super().__init__(name)
        self.canonical_template = 'Escribe unha palabra que conteña a letra "{letter}":'
        self.second_template = 'Escribe unha palabra usando a letra "{letter}":'
        self.third_template = 'Escribe unha palabra na que estea a letra "{letter}":'
