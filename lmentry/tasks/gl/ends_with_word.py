...
from lmentry.scorers.gl.ends_with_word_scorer import EndsWithWordScorer
...
class EndsWithWord(LMentryTask):
    ...
    def __init__(self, name="ends_with_word"):
        super().__init__(name)
        self.canonical_template = 'Escribe unha oración que remate ca palabra "{word}":'
        self.second_template = 'Escribe unha oración cuxa última palabra sexa "{word}":'
        self.third_template = 'Escribe unha oración que remate con "{word}":'
