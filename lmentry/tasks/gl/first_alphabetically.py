...
from lmentry.scorers.gl.first_alphabetically_scorer import FirstAlphabeticallyScorer
...
class FirstAlphabetically(LMentryTask):
    ...
    def __init__(self, name="first_alphabetically", words_path=None):
        super().__init__(name)
        self.canonical_template = "Nunha orde alfabética, cal das palabras \"{word1}\" e \"{word2}\" vén primeiro?"
        self.second_template = "Nunha orde alfabética, que palabra vén primeiro: \"{word1}\" ou \"{word2}\"?"
        self.third_template = "Das palabras \"{word1}\" e \"{word2}\", cal delas vén primeiro en orde alfabético?"
