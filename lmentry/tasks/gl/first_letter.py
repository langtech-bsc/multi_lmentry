...
from lmentry.scorers.gl.first_letter_scorer import FirstLetterScorer
...
class FirstLetter(LMentryTask):
    ...
    def __init__(self, name="first_letter"):
        ...
        self.canonical_template = 'Cal é a primeira letra da palabra "{word}"?'
        self.second_template = 'Por que letra comeza a palabra "{word}"?'
        self.third_template = 'Escribe a primeira letra da palabra "{word}":'
