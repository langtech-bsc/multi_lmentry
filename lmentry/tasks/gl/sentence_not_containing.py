...
from lmentry.scorers.gl.sentence_not_containing_scorer import SentenceNotContainingScorer
...
class SentenceNotContaining(LMentryTask):
    ...
    def __init__(self, name="sentence_not_containing"):
        super().__init__(name)
        self.canonical_template = 'Escribe unha oración que non conteña a palabra"{word}":'
        self.second_template = 'Escribe unha oración sen usar a palabra "{word}":'
        self.third_template = 'Escribe unha oración na que non estea contida a palabra "{word}":'
