...
from lmentry.scorers.gl.more_letters_scorer import MoreLettersScorer
...
class MoreLettersLengthDiff1(LMentryTask):
    ...
    def __init__(self, name="more_letters_length_diff_1"):
        ...
        self.canonical_template = 'Que palabra ten máis letras: "{word1}" ou "{word2}"?'
        self.second_template = 'Que palabra é máis longa: "{word1}" ou "{word2}"?'
        self.third_template = 'Das palabras "{word1}" e "{word2}" cal ten máis letras?'
    ...
    def create_data(self, num_examples=1000, seed=None, task_data_path=None):
        ...
        for template_id, template in enumerate(self.all_templates):
            ...
            while num_examples_created < num_examples:
                ...
                distractor_options = []
                for l in range(answer_length - 1, answer_length):  # the distractor is 1 letter shorter
                    if l in source_data:
