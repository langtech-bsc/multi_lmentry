...
from lmentry.scorers.gl.last_letter_scorer import LastLetterScorer
...
class LastLetter(LMentryTask):
    ...
    def __init__(self, name="last_letter"):
        ...
        self.canonical_template = 'Cal é a última letra da palabra "{word}"?'
        self.second_template = 'Por que letra remata a palabra "{word}"?'
        self.third_template = 'Escribe a última letra da palabra "{word}":'
