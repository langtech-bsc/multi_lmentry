...
from lmentry.scorers.gl.first_word_scorer import FirstWordScorer
...
class FirstWord(LMentryTask):
    ...
    def __init__(self, name="first_word"):
        ...
        self.canonical_template = 'Cal é a primeira palabra da oración "{sentence}"?'
        self.second_template = 'Na oración "{sentence}", cal é a primeira palabra?'
        self.third_template = 'Escribe a primeira palabra da oración "{sentence}":'
