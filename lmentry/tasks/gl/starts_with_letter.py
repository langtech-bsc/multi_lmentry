...
from lmentry.scorers.gl.starts_with_letter_scorer import StartsWithLetterScorer
...
class StartsWithLetter(LMentryTask):
    ...
    def __init__(self, name="starts_with_letter"):
        ...
        self.canonical_template = 'Escribe unha palabra que comece pola letra "{letter}":'
        self.second_template = 'Escribe unha palabra cuxa primeira letra sexa "{letter}":'
        self.third_template = 'Escribe unha palabra que comece por "{letter}":'
    ...
    def create_data(self, task_data_path=None):
        ...
        allowed_letters = set(gl_letters) - {"j", "k", "ñ", "w", "y"}
