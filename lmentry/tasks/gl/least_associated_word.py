...
from lmentry.scorers.gl.least_associated_word_scorer import LeastAssociatedWordScorer
...
class LeastAssociatedWord(LMentryTask):
    ...
    def __init__(self, name="least_associated_word"):
        ...
        self.canonical_template = \
            'Das palabras {options}, cal é a palabra menos asociada con "{category}"?'
        self.second_template = \
            'Cal é a palabra menos relacionada ca palabra "{category}" das palabras {options}?'
        self.third_template = \
            'Das seguintes palabras, escolle a palabra menos asociada ca palabra "{category}" - {options}:'
