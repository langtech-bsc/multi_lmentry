...
from lmentry.scorers.gl.bigger_number_scorer import BiggerNumberScorer
...
class BiggerNumber(LMentryTask):
    ...
    def __init__(self, name="bigger_number"):
        super().__init__(name)
        self.canonical_template = "Que número é maior: {n1} ou {n2}?"
        self.second_template = "Dos números {n1} e {n2}, cal é maior?"
        self.third_template = "Dos números {n1} e  {n2}, escribe o número maior:"
