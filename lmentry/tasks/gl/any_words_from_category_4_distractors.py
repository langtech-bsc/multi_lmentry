...
from lmentry.scorers.gl.any_words_from_category_scorer import AnyWordsFromCategoryScorer
...
class AnyWordsFromCategory4Distractors(LMentryTask):
    ...
    def __init__(self, name="any_words_from_category_4_distractors"):
        ...
        self.canonical_template = 'Algunha destas palabras {words} son do tipo {category}? Responde "si" ou "non".'
        self.second_template = 'Dalgunha das palabras {words} represéntase {category}? Responde "si" ou "non".'
        self.third_template = 'Da seguinte lista [{words}] contén algunha {category}? Responde "si" ou "non".'
