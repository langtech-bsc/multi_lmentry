...
from lmentry.scorers.gl.ends_with_letter_scorer import EndsWithLetterScorer
...
class EndsWithLetter(LMentryTask):
    ...
    def __init__(self, name="ends_with_letter"):
        ...
        self.canonical_template = 'Escribe unha palabra que remate pola letra "{letter}":'
        self.second_template = 'Escribe unha palabra cuxa última letra sexa "{letter}":'
        self.third_template = 'Escribe unha palabra que remate por "{letter}":'
    ...
    def create_data(self, task_data_path=None):
        ...
        allowed_letters = set(gl_letters) - {"b", "c", "d", "f", "g", "h", "j", "k", "m", "ñ", "p", "q", "t", "v", "w", "x", "y"}
