...
from lmentry.scorers.gl.sentence_containing_scorer import SentenceContainingScorer
...
class SentenceContaining(LMentryTask):
    ...
    def __init__(self, name="sentence_containing"):
        super().__init__(name)
        self.canonical_template = 'Escribe unha oración que conteña a palabra "{word}":'
        self.second_template = 'Escribe unha oración usando a palabra "{word}":'
        self.third_template = 'Escribe unha oración na que estea a palabra "{word}":'
