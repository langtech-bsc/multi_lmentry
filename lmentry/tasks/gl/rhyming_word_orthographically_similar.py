...
from lmentry.scorers.gl.rhyming_word_scorer import RhymingWordScorer
...
class RhymingWordOrthographicallySimilar(LMentryTask):
    ...
    def __init__(self, name="rhyming_word_orthographically_similar"):
        super().__init__(name)
        self.canonical_template = "Que palabra rima con \"{query}\": \"{word1}\" ou \"{word2}\"?"
        self.second_template = "Cal é unha rima de \"{query}\": \"{word1}\" ou \"{word2}\"?"
        self.third_template = "Das palabras \"{word1}\" e \"{word2}\", cal riman con  \"{query}\"?"
