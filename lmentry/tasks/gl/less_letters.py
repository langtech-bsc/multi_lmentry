...
from lmentry.scorers.gl.less_letters_scorer import LessLettersScorer
...
class LessLetters(LMentryTask):
    ...
    def __init__(self, name="less_letters"):
        ...
        self.canonical_template = 'Que palabra ten menos letras: "{word1}" ou "{word2}"?'
        self.second_template = 'Que palabra é máis curta: "{word1}" ou "{word2}"?'
        self.third_template = 'Das palabras "{word1}" e "{word2}"cal ten menos letras?'
