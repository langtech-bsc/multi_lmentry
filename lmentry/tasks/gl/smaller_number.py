...
from lmentry.scorers.gl.smaller_number_scorer import SmallerNumberScorer
...
class SmallerNumber(LMentryTask):
    ...
    def __init__(self, name="smaller_number"):
        super().__init__(name)
        self.canonical_template = "Que número é menor: {n1} ou {n2}?"
        self.second_template = "Dos números {n1} e {n2}, cal é menor?"
        self.third_template = "Dos números  {n1} e {n2}, escribe o número menor:"
