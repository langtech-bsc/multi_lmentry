...
from lmentry.scorers.gl.homophone_scorer import HomophoneScorer
...
class Homophones(LMentryTask):
    ...
    def __init__(self, name="homophones"):
        super().__init__(name)
        self.canonical_template = "Que palabra soa como a palabra \"{query}\": \"{word1}\" ou \"{word2}\"?"
        self.second_template = "Das dúas palabras \"{word1}\" e \"{word2}\", cal soa máis como \"{query}\"?"
        self.third_template = "Cal é un homófono da palabra \"{query}\": \"{word1}\" ou \"{word2}\"?"
