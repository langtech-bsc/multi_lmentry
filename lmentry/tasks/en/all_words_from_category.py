...
class AllWordsFromCategory(LMentryTask):
    ...
    def __init__(self, name="all_words_from_category"):
        ...
        self.canonical_template = 'Are all the words {words} types of {category}? Answer either "yes" or "no".'
        self.second_template = 'Do the words {words} all represent {category}? Answer either "yes" or "no".'
        self.third_template = 'Does the list [{words}] contain only {category}? Answer either "yes" or "no".'
