...
class AnyWordsFromCategory3Distractors(LMentryTask):
    ...
    def __init__(self, name="any_words_from_category_3_distractors"):
        ...
        self.canonical_template = 'Are any of the words {words} types of {category}? Answer either "yes" or "no".'
        self.second_template = 'Do any of the words {words} represent {category}? Answer either "yes" or "no".'
        self.third_template = 'Does the list [{words}] contain any {category}? Answer either "yes" or "no".'
