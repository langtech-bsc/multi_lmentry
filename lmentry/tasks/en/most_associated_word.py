...
class MostAssociatedWord(LMentryTask):
    ...
    def __init__(self, name="most_associated_word"):
        ...
        self.canonical_template = \
            'Of the words {options}, what is the word most commonly associated with "{category}"?'
        self.second_template = 'What is the word most related to the word "{category}" from the words {options}?'
        self.third_template = \
