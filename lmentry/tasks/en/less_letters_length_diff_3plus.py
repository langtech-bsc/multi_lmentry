...
class LessLettersLengthDiff3plus(LMentryTask):
    ...
    def __init__(self, name="less_letters_length_diff_3plus"):
        ...
        self.canonical_template = 'Which word has fewer letters, "{word1}" or "{word2}"?'
        self.second_template = 'Which word is shorter, "{word1}" or "{word2}"?'
        self.third_template = 'Of the words "{word1}" and "{word2}" which one has fewer letters?'
