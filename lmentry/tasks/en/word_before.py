...
class WordBefore(LMentryTask):
    ...
    def __init__(self, name="word_before"):
        ...
        self.second_template = 'In the sentence "{sentence}", which word immediately precedes the word "{word}"?'
        self.third_template = 'Which word comes right before "{word}" in the sentence "{sentence}"?'
