...
class FirstAlphabeticallyConsecutiveFirstLetter(LMentryTask):
    ...
    def __init__(self, name="first_alphabetically_consecutive_first_letter", words_path=None):
        super().__init__(name)
        self.canonical_template = "In an alphabetical order, which of the words \"{word1}\" and \"{word2}\" comes first?"
        self.second_template = "In an alphabetical order, which word comes first, \"{word1}\" or \"{word2}\"?"
        self.third_template = "Of the words \"{word1}\" and \"{word2}\", which word comes first alphabetically?"
