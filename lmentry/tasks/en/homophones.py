...
class Homophones(LMentryTask):
    ...
    def __init__(self, name="homophones"):
        super().__init__(name)
        self.canonical_template = "Which word sounds like the word \"{query}\", \"{word1}\" or \"{word2}\"?"
        self.second_template = "Of the two words \"{word1}\" and \"{word2}\", which one sounds more like \"{query}\"?"
        self.third_template = "Which is a homophone of the word \"{query}\", \"{word1}\" or \"{word2}\"?"
