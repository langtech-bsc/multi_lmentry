...
class LeastAssociatedWord(LMentryTask):
    ...
    def __init__(self, name="least_associated_word"):
        ...
        self.canonical_template = \
            'Of the words {options}, what is the word least associated with "{category}"?'
        self.second_template = 'What is the word least related to the word "{category}" from the words {options}?'
        self.third_template = \
