...
from lmentry.scorers.ko.bigger_number_scorer import BiggerNumberScorer
...
class BiggerNumber(LMentryTask):
    ...
    def __init__(self, name="bigger_number"):
        super().__init__(name)
        self.canonical_template = "{n1}과 {n2} 중 어느 쪽이 더 큰 숫자입니까?"
        self.second_template = "{n1}과 {n2} 중 어느 것이 더 큽니까?"
        self.third_template = "{n1} 및 {n2}에서 더 큰 숫자를 적으시오:"
