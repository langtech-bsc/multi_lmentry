...
from lmentry.scorers.ko.sentence_not_containing_scorer import SentenceNotContainingScorer
...
class SentenceNotContaining(LMentryTask):
    ...
    def __init__(self, name="sentence_not_containing"):
        super().__init__(name)
        self.canonical_template = '"{word}"라는 단어가 포함되지 않는 문장을 작성하시오:'
        self.second_template = '"{word}"라는 단어를 사용하지 않고 문장을 작성하시오:'
        self.third_template = '"{word}"라는 단어를 포함하지 않는 문장을 작성하시오:'
