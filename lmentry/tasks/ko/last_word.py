...
from lmentry.scorers.ko.last_word_scorer import LastWordScorer
...
class LastWord(LMentryTask):
    ...
    def __init__(self, name="last_word"):
        ...
        self.canonical_template = '문장 "{sentence}"의 마지막 단어는 무엇입니까?"'
        self.second_template = '"{sentence}"이라는 문장에서 마지막 단어는 무엇입니까?'
        self.third_template = '문장 "{sentence}"의 마지막 단어를 작성하시오.'
