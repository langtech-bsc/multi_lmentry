...
from lmentry.scorers.ko.any_words_from_category_scorer import AnyWordsFromCategoryScorer
...
class AnyWordsFromCategory4Distractors(LMentryTask):
    ...
    def __init__(self, name="any_words_from_category_4_distractors"):
        ...
        self.canonical_template = '{words} 단어 중에"{category}"유형이 있습니까? "예" 또는 "아니오" 중 하나에 답하십시오."'
        self.second_template = '{words} 단어 중"{category}" 나타내는 단어가 있습니까? "예" 또는 "아니오" 중 하나에 답하십시오.'
        self.third_template = '다음 목록 [{words}]에 {category}가 포함되어 있습니까? "예" 또는 "아니오" 중 하나로 답하십시오.'
