...
from lmentry.scorers.ko.starts_with_word_scorer import StartsWithWordScorer
...
class StartsWithWord(LMentryTask):
    ...
    def __init__(self, name="starts_with_word"):
        super().__init__(name)
        self.canonical_template = '시작하는 단어가 "{word}"인 문장을 작성하시오:'
        self.second_template = '첫 번째 단어가 "{word}"인 문장을 작성하시오:'
        self.third_template = '"{word}"로 시작하는 문장을 작성하시오:'
