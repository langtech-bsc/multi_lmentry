...
class WordBefore(LMentryTask):
    ...
    def __init__(self, name="word_before"):
        ...
        self.canonical_template = '다음 문장에서 "{sentence}" , "{word}" 바로 앞에 오는 단어는 무엇입니까?'
        self.second_template = '주어진 문장 "{sentence}"에서 "{word}"의 바로 직전 단어는 무엇입니까?'
        self.third_template = '어떤 단어가 "{sentence}"에서 "{word}" 바로 앞에 있습니까?'
