...
from lmentry.scorers.ko.word_containing_scorer import WordContainingScorer
...
class WordContaining(LMentryTask):
    ...
    def __init__(self, name="word_containing"):
        super().__init__(name)
        self.canonical_template = '"{letter}"가 포함된 단어를 작성하시오:'
        self.second_template = '"{letter}"를 사용하여 단어를 작성하시오:'
        self.third_template = '"{letter}"를 포함하는 단어를 작성하시오:'
