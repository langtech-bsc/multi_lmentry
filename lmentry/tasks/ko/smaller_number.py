...
from lmentry.scorers.ko.smaller_number_scorer import SmallerNumberScorer
...
class SmallerNumber(LMentryTask):
    ...
    def __init__(self, name="smaller_number"):
        super().__init__(name)
        self.canonical_template = '{n1}과 {n2} 중 어떤 숫자가 더 작습니까?'
        self.second_template = '숫자 {n1}과 {n2} 중 더 작은 것은 무엇입니까?'
        self.third_template = '{n1} 및 {n2} 중에서 더 작은 숫자를 쓰시오:'
