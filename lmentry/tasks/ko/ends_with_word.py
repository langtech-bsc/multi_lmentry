...
from lmentry.scorers.ko.ends_with_word_scorer import EndsWithWordScorer
...
class EndsWithWord(LMentryTask):
    ...
    def __init__(self, name="ends_with_word"):
        super().__init__(name)
        self.canonical_template = '끝나는 단어가 "{word}"인 문장을 작성하시오:'
        self.second_template = '마지막 단어가 "{word}"인 문장을 작성하시오:'
        self.third_template = '"{word}"로 끝나는 문장을 작성하시오:'
