...
from lmentry.scorers.ko.less_letters_scorer import LessLettersScorer
...
class LessLettersLengthDiff3plus(LMentryTask):
    ...
    def __init__(self, name="less_letters_length_diff_3plus"):
        ...
        self.canonical_template = '더 적은 글자를 가진 것은 단어 {word1}"과 "{word2}" 중 어느 것입니까?"'
        self.second_template = '"{word1}"과 "{word2}" 중 어느 단어가 더 짧습니까?'
        self.third_template = '"{word1}"과 "{word2}" 중 어느 것이 더 적은 글자를 가지고 있습니까?'
