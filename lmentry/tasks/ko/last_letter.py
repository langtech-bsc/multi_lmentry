...
from lmentry.scorers.ko.last_letter_scorer import LastLetterScorer
...
class LastLetter(LMentryTask):
    ...
    def __init__(self, name="last_letter"):
        ...
        self.canonical_template = '"{word}"의 마지막 글자는 무엇입니까?'
        self.second_template = '"{word}"는 어떤 글자로 끝납니까?'
        self.third_template = '"{word}"의 마지막 글자를 작성하시오:'
