...
from lmentry.scorers.ko.all_words_from_category_scorer import AllWordsFromCategoryScorer
...
class AllWordsFromCategory(LMentryTask):
    ...
    def __init__(self, name="all_words_from_category"):
        ...
        self.canonical_template = '{words} 단어가 모두"{category}"유형입니까? "예" 또는 "아니오" 중 하나로 답하십시오."'
        self.second_template = '{words} 단어가 모두"{category}" 나타냅니까? "예" 또는 "아니오" 중 하나로 답하십시오.'
