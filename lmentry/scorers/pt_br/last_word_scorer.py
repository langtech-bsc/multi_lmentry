...
class LastWordScorer(LMentryScorer):
    ...
    def get_base_patterns(self, answer, sentence):
        ...
        base_patterns = [
            rf"A última palavra é {answer}",
            rf"A última palavra (de|em|da frase) {sentence} é {answer}",
            rf"A palavra final (de|em|da frase) {sentence} é {answer}",
            rf"{answer} é a última palavra",
            rf"{answer} é a palavra final",
            rf"{sentence} termina com {answer}",
            rf"{sentence} termina com a palavra {answer}",
            rf"Última palavra: {answer}",
        ]
