...
class MostAssociatedWordScorer(LMentryScorer):
    ...
    def get_base_patterns(self, answer, category, words):
        ...
        most_associated_with = r"más (associada a|associada com|relacionada a|relacionada com)"

        base_patterns = [
            rf"A palavra {most_associated_with} {category} é {answer}",
            rf"A palavra {most_associated_with} {category} entre {words} é {answer}",
            rf"A categoria {category} é a {most_associated_with} {answer}",
            rf"{answer} é a palavra {most_associated_with} {category}",
            rf"{answer} é a {most_associated_with} {category}",
        ]
