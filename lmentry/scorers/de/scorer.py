...
word_regex_template = r'(Das Wort )?["\'\.,]*\b{}\b["\'\.,]*'
sentence_regex_template = r'((Der Satz )?["\'\.,]*{}["\'\.,]*|Der Satz)'
letter_regex_template = r'(Der Buchstabe )?["\'\.,]*\b{}\b["\'\.,]*'
number_regex_template = r'(Die Zahl )?["\'\.,]*\b{}\b["\'\.,]*'
...
def the_words_regex(words: list[str]):
    ...
    return rf"(Die Wörter )?{words_regex}"
...
def the_list_regex(words: list[str]):
    ...
    return rf"(((Die Liste )?{words_as_string})|die Liste)"
...
class LMentryScorer:
    ...
    def get_shared_patterns(target):
        ...
        patterns = [
            rf"{target} ist die Antwort",
            rf"{target} ist die richtige Antwort",
            rf"Die Antwort ist {target}",
            rf"Die richtige Antwort ist {target}",
            rf"Die korrekte Antwort ist {target}",
            rf"Antwort: {target}"
        ]
