...
class StartsWithWordScorer(LMentryScorer):
    def __init__(self):
        ...
        self.prefixes = [
            r"Der Satz( ist)?",
            r"{a_} Satz, der mit {word} startet,( ist)?",
            r"{a_} Satz, dessen erstes Wort {word} ist,( ist)?",
        ]
        # we don't want an empty suffix here
        self.suffixes = [
            r"beginnt mit {word}",
            r"ist ein Satz, der mit {word} beginnt",
            r"ist ein Satz, dessen erstes Wort {word} ist",
        ]
