...
from lmentry.scorers.en.scorer import LMentryScorer, the_sentence_regex, the_word_regex
...
class FirstWordScorer(LMentryScorer):
    ...
    def get_base_patterns(self, answer, sentence):
        ...
        base_patterns = [
            rf"Das erste Wort ist {answer}",
            rf"Das erste Wort (von|in) {sentence} ist {answer}",
            rf"{answer} ist das erste Wort",
            rf"{sentence} beginnt mit {answer}",
            rf"{sentence} fängt mit {answer} an",
            rf"Erstes Wort: {answer}",
        ]
