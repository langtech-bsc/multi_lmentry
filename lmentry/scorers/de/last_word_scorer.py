...
class LastWordScorer(LMentryScorer):
    ...
    def get_base_patterns(self, answer, sentence):
        ...
        base_patterns = [
            rf"Das letzte Wort ist {answer}",
            rf"Das letzte Wort (von|in) {sentence} ist {answer}",
            rf"{answer} ist das letzte Wort",
            rf"{sentence} endet mit {answer}",
            rf"Letztes Wort: {answer}",
        ]
