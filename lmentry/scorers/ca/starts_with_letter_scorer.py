...
class StartsWithLetterScorer(LMentryScorer):
    ...
    def get_base_patterns(self, letter, word):
        ...
        base_patterns = [
            ...
            rf"{word} comença amb {letter}",
            rf"{word} és {a} paraula que comença amb la lletra {letter}",
            rf"{a} paraula que comença en {letter} és {word}",
            rf"{a} paraula que comença amb la lletra {letter} és {word}",
            rf"{word} és {a} paraula la primera lletra de la qual és {letter}",
        ]
    ...
    def score_prediction(self, prediction, example, truncate_prediction: bool = False):
        ...
        after_the_letter = r"\w*" if letter in {"a", "i", "o"} else r"\w+" #Allow single letter words
