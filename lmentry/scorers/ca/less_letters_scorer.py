...
class LessLettersScorer(LMentryScorer):
    ...
    def get_base_patterns(self, answer, distractor, diff):
        ...
        base_patterns = [
            rf"{answer} té menys lletres",
            rf"{answer} té menys lletres que {distractor}",
            rf"{answer} té {diff} {letter} menys",
            rf"{answer} té {diff} {letter} menys que {distractor}",
            rf"La paraula que té menys lletres és {answer}",
            rf"{answer} és la paraula que té menys lletres",
            rf"{answer} és la paraula més curta",
            rf"{answer} és més curta que {distractor}",
            rf"{answer} és més curta que {distractor} per una diferència de {diff} {letter}",
            rf"La paraula més curta és {answer}",
        ]
        # replace less with more and swap answer and distractor
        more_base_patterns1 = [
            swap_substrings(s, subs1=answer, subs2=distractor).replace("menys", "més")
        ...
        more_base_patterns2 = [
            swap_substrings(s, subs1=answer, subs2=distractor).replace("curta", "llarga")
            for s in base_patterns
            if "curta" in s
        ]
    ...
    def negative_scorer(self, prediction, answer, distractor, diff):
        ...
        negative_patterns = [
            distractor,
            rf"{distractor} té menys lletres",
            rf"{distractor} té menys lletres que {answer}",
            rf"{distractor} té {diff} {letter} menys",
            rf"{distractor} té {diff} {letter} menys que {answer}",
            rf"La paraula que té menys lletres és {distractor}",
            rf"{distractor} és la paraula que té menys lletres",
            rf"{distractor} és la paraula més curta",
            rf"{distractor} és més curta per {diff} {letter}",
            rf"{distractor} és més curta que {answer}",
            rf"{distractor} és més curta que {answer} per una diferència de {diff} {letter}",
            rf"La paraula més curta és {distractor}",
        ]
        ...
        wrong_diff_patterns = [
            rf"{answer} té {number_regex} {letter} menys",
            rf"{answer} té {number_regex} {letter} menys que {distractor}",
            rf"{answer} és més curta per {number_regex} {letter}",
            rf"{answer} és més curta que {distractor} per una diferència de {number_regex} {letter}",
        ]
