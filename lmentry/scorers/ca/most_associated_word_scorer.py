...
class MostAssociatedWordScorer(LMentryScorer):
    ...
    def get_base_patterns(self, answer, category, words):
        ...
        most_associated = r"més (associada a |relacionada amb)"

        base_patterns = [
            rf"La paraula {most_associated} {category} és {answer}",
            rf"La paraula {most_associated} {category} d'entre {words} és {answer}",
            rf"La categoria {category} està {most_associated} {answer}",
            rf"{answer} és la paraula {most_associated} {category}",
            rf"La paraula que més es relaciona amb {category} és {answer}",
            rf"{answer} es relaciona més amb {category}",
        ]
