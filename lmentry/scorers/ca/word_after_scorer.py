...
class WordAfterScorer(LMentryScorer):
    ...
    def get_base_patterns(self, answer, query, sentence):
        ...
        base_patterns = [
            ...
            rf"{answer} és la paraula que {comes} {after} {query}",
            rf"{answer} és la paraula {after} {query}",
            rf"La paraula que {comes} {after} {query} és {answer}",
            rf"La paraula que {comes} {after} {query} a {sentence} és {answer}",
            rf"La paraula {after} {query} és {answer}",
            rf"{query} {comes} seguit de {answer}",
        ]
