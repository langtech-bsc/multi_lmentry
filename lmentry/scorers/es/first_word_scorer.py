...
from lmentry.scorers.es.scorer import LMentryScorer, the_sentence_regex, the_word_regex
...
class FirstWordScorer(LMentryScorer):
    ...
    def get_base_patterns(self, answer, sentence):
        ...
        base_patterns = [
            rf"La primera palabra es {answer}",
            rf"La primera palabra (de|en) {sentence} es {answer}",
            rf"{answer} es la primera palabra",
            rf"{sentence} empieza con {answer}",
            rf"{sentence} comienza con {answer}",
            rf"Primera palabra: {answer}",
        ]
