...
class MostAssociatedWordScorer(LMentryScorer):
    ...
    def get_base_patterns(self, answer, category, words):
        ...
        most_associated = r"más (asociada a|asociada con|relacionada con)"

        base_patterns = [
            rf"La palabra {most_associated} {category} es {answer}",
            rf"La palabra {most_associated} {category} entre {words} es {answer}",
            rf"La categoría {category} es la {most_associated} {answer}",
            rf"{answer} es la palabra {most_associated} {category}",
            rf"{answer} es la {most_associated} {category}",
            rf"La palabra más relacionada con {category} es {answer}",
        ]
