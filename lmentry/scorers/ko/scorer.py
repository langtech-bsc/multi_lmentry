...
word_regex_template = r'(다음 단어 )?["\'\.,]*\b{}\b["\'\.,]*'
sentence_regex_template = r'((다음 문장 )?["\'\.,]*{}["\'\.,]*|다음 문장)'
letter_regex_template = r'(다음 글자 )?["\'\.,]*\b{}\b["\'\.,]*'
number_regex_template = r'(다음 숫자 )?["\'\.,]*\b{}\b["\'\.,]*'
...
def the_list_regex(words: list[str]):
    ...
    return rf"(((다음 문장 )?{words_as_string})|다음 문장)"
