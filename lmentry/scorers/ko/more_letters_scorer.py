...
class MoreLettersScorer(LMentryScorer):
    ...
    def get_base_patterns(self, answer, distractor, diff):
        ...
        more_ = f"(많다|많습니다|더 많다|더 많습니다|더 길다|길다)"
        base_patterns = [
            rf"{answer}{is_} 글자 수가 {more_}",
            rf"{answer}{is_} {distractor}보다 글자 수가 {more_}",
            rf"{answer}{is_} {diff}개의 글자가 {more_}",
            rf"{answer}는 {distractor}보다 {diff}개의 글자가 더 {more_}",
            rf"글자 수가 (많은|더 많은) 단어는 {answer}입니다",
            rf"{answer}{is_} 글자 수가 더 많은 단어입니다",
            rf"{answer}{is_} {more_}",
            rf"{answer}{is_} {distractor}보다 {more_}",
            rf"{answer}{is_} {distractor}보다 {diff}글자만큼 {more_}",
            rf"더 긴 단어는 {answer}입니다",
            rf"더 긴 단어는 {answer}입니다",
            rf"{answer}{is_} 더 긴 단어입니다",
        ]

        # replace more with less or fewer and swap answer and distractor
        less = r"(적다|더 적다)"
        more_base_patterns1 = [
            swap_substrings(s, subs1=answer, subs2=distractor).replace("많다", less)
    ...
    def negative_scorer(self, prediction, answer, distractor, diff):
        ...
        negative_patterns = [
            distractor,
            rf"{distractor}{is_} 글자 수가 {more_}",
            rf"{distractor}{is_} {distractor}보다 글자 수가 {more_}",
            rf"{distractor}{is_} {diff}개의 글자가 {more_}",
            rf"{distractor}는 {answer}보다 {diff}개의 글자가 더 {more_}",
            rf"글자 수가 (많은|더 많은) 단어는 {distractor}입니다",
            rf"{distractor}{is_} 글자 수가 더 많은 단어입니다",
            rf"{distractor}{is_} {more_}",
            rf"{distractor}{is_} {answer}보다 {more_}",
            rf"{distractor}{is_} {answer}보다 {diff}글자만큼 {more_}",
            rf"더 긴 단어는 {distractor}입니다",
            rf"더 긴 단어는 {distractor}입니다",
            rf"{distractor}{is_} 더 긴 단어입니다",
        ]
        ...
        wrong_diff_patterns = [
            rf"{answer}{is_} 글자 수가 {number_regex} 개 {more_}",
            rf"{answer}{is_} {distractor}보다 글자 수가 {number_regex} 개 {more_}",
            rf"{answer}{is_} {number_regex} 글자만큼 {more_}",
            rf"{answer}{is_} {distractor}보다 {number_regex} 글자만큼 {more_}",
        ]
