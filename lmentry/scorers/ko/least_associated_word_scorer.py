...
class LeastAssociatedWordScorer(LMentryScorer):
    ...
    def get_base_patterns(self, answer, category, words):
        ...
        least_associated = r"가장 덜 (연관된|관련된)" 
        less = r"(적게|덜)" 
        is_ = r"(이|가|은|는|와|과|의|에서|을|를)"
        
        
        base_patterns = [
            rf"{category}{is_} {least_associated} 단어는 {answer}입니다",
            rf"{category}{is_} {words}{is_} {least_associated} 단어는 {answer}입니다",
            rf"{category}{is_} {answer}{is_} 가장 {less} 연관되어 있다.",
            rf"{category}{is_} {answer}{is_} 가장 {less} 관련되어 있다.",
            rf"{answer}{is_} {category}{is_} 가장 {less} 연관된 단어입니다",
            rf"{answer}{is_} {category}{is_} 가장 {less} 연관된 단어입니다",
            rf"{category}{is_} 가장 {less} 관련된 단어는 {answer}입니다",
            rf"{answer}{is_} 카테고리 {category}{is_} 가장 {less} 관련되어 있습니다",
        ]
