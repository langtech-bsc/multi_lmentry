...
from lmentry.scorers.eu.scorer import LMentryScorer, the_sentence_regex
...
class SentenceContainingScorer(LMentryScorer):
    def __init__(self):
        ...
        # 'Idatzi "{word}" hitza duen esaldi bat:\n'
        # 'Idatzi esaldi bat "{word}" hitza erabiliz:\n'
        # 'Idatzi esaldi bat zeinetan "{word}" hitza agertzen den:\n'
