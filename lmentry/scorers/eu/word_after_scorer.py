...
class WordAfterScorer(LMentryScorer):
    def __init__(self):
        ...
        # 'Q: "{sentence}" esaldian, zein hitz dago "{word}" atze-atzetik?\nA:'
        # 'Q: "{sentence}" esaldian, zein hitz dago "{word}" ondoren?\nA:'
        # 'Q: Zein hitz dator "{word}" eta gero "{sentence}" esaldian?\nA:'
    ...
    def get_base_patterns(self, answer, query, sentence):
        ...
        base_patterns = [
            rf"{of_query} {after} {answer} {comes}",
            rf"{answer} {comes} {of_query} {after}",
            rf"{of_query} {after} (datorren|doan|dagoen) hitza {answer} da",
            rf"{answer} da {of_query} {after} (datorren|doan|dagoen) hitza",
