...
class LeastAssociatedWordScorer(LMentryScorer):
    ...
    def __init__(self):
        ...
        # Q: {options} hitzen artean, zeinek du lotura gutxien "{category}" kategoriarekin?
        # Q: Zein hitz erlazionatzen da gutxien "{category}" kategoriarekin {options} hitzen artean?
        # Hurrengo hitzen artean, aukeratu "{category}" kategoriarekin lotura gutxien duen hitza - {options}
    ...
    def get_base_patterns(self, answer, category, words):
        ...
        has = r"(du|dauka)"
        less = r"(gutxien|gutxiago)"
        relation = r"(lotura|erlazio|zerikusi)"

        base_patterns = [
            rf"{answer}( hitza)? da",
            rf"{answer}( hitza)? da {with_category} {relation} {less} (duena|daukana)",
            rf"{with_category} {relation} {less} (duena|daukana) {answer}( hitza)? da",
            rf"{answer}( hitza)? da {with_category} {relation} {less} (duen|daukan) hitza",
            rf"{with_category} {relation} {less} (duen|daukan) hitza {answer}( hitza)? da",
            rf"{answer}( hitza)? {less} erlazionatzen da",
            rf"{answer}( hitza)? erlazionatzen da {less}",
            rf"{answer}( hitza)? da {with_category} {less} erlazionatzen (dena|den hitza)",
            rf"{with_category} {less} erlazionatzen (dena|den hitza) {answer}( hitza)? da",
            rf"{answer} hitzak {has} {relation} {less}",
            rf"{answer} hitzak {has} {relation} {less} {with_category}",
            rf"{with_category} {answer} hitzak {has} {relation} {less}"
        ]
