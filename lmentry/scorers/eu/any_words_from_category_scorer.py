...
class AnyWordsFromCategoryScorer(LMentryScorer):
    ...
    # 'Q: {words} hitzetako baten bat da {category} bat? Erantzun "bai" edo "ez".\nA:'
    # 'Q: {words} hitzetako baten batek adierazten du {category} bat? Erantzun "bai" edo "ez".\nA:'
    # 'Q: [{words}] zerrendak badu {category} bat bat? Erantzun "bai" edo "ez".\nA:'
    ...
    def score_prediction(self, prediction, example, truncate_prediction: bool = False):
        ...
        answer = "bai" if num_words > num_distractors else "ez"
