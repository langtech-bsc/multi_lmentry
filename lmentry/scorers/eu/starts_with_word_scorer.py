...
class StartsWithWordScorer(LMentryScorer):
    def __init__(self):
        ...
        # 'Idatzi "{word}" hitzarekin hasten den esaldi bat:\n'
        # 'Idatzi esaldi bat zeinen lehenengo hitza "{word}" den:\n'
        # 'Idatzi esaldi bat "{word}" hitzarekin hasita:\n'

        first = "(lehen|lehenengo|hasierako)"
        word = r"\"?{word}\"?"
        ...
        self.prefixes.extend([
            rf"{with_word} {starting} den {a_sentence}( da)? ",
            rf"{with_word} {starting} den {a_sentence}: ",
        ])

        self.suffixes.extend([
            r" da",
            fr" esaldian, {first} hitza {word} da",
            fr" esaldiaren {first} hitza {word} da",
        ])
